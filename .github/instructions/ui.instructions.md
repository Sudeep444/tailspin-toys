...
- Document component APIs with TypeScript types and public prop contracts
- Prefer comments that explain why a component exists or why a prop matters, not how the markup is structured
